...
import { IoAdd, IoTime, IoChevronBack } from 'react-icons/io5';
...
export default function Sidebar({
  ...
  const [activeItem, setActiveItem] = useState('crear-orden');
  ...
  return (
    <motion.div
      ...
      className='bg-white border-r border-gray-200 h-screen flex flex-col fixed top-0 left-0 z-30'
    >
      {/* Header */}
      <div className='p-6 '>
